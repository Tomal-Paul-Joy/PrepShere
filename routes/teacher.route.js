...
const { getUser, createUser, findUser, goToMainPage, goToRoutine, logout, seePapers, seePapersPages, seePaperCheck, paperCheck, goToPdf, createPdf, getAllPdfs, createVideo, seeVideo } = require("../controllers/teacher"); 
